...
function ComposerDemo() {
  const [value, setValue] = useState("What about the other one?");
    ...
    <div className="min-h-full bg-bg">
      <div className="mx-auto max-w-3xl space-y-12 px-6 py-10">
        <header className="space-y-4">
          ...
          <PageHeader
            title="UI kit"
            description="Atomic → complex. Same paper/ink theme as the landing. Dev-only preview — excluded from production builds."
          />
        </header>
        ...
        <Section title="Atomic">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              <Input aria-invalid defaultValue="" placeholder="Required" />
            </Field>
          </div>
