  ...
  const rows = [
    {
      ...
      details: [
        { label: "Fetched", meta: "412 new" },
        { label: "Unchanged", meta: "1,204" },
      ],
    },
    {
      key: "index",
      ...
      pill: null,
      details: [
        { label: "Artifacts written", meta: "61" },
        { label: "People resolved", meta: "24" },
      ],
    },
    {
      key: "draft",
      ...
      details: [
        { label: "Refresh token expired", meta: "needs_reauth" },
        { label: "Retry after reconnect", meta: "queued" },
      ],
    },
  ];
