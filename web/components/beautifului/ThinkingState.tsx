 ...
 *
 *   Steps      planner + lanes with spinner → muted checks
 *   Reasoning  graph path that expands, then settles
 *   Search     docs read from memory
 *   Lookups    live connector fetches (read-only)
 *
...
> = {
  Steps: {
    active: "Planning",
    done: "Planned in 4 seconds",
    rows: [
      { primary: "Rewriting the question" },
      { primary: "Running vector, phrase, and graph lanes" },
      { primary: "Reranking fused hits", secondary: "12 docs" },
      { primary: "Checking the abstain floor" },
    ],
  },
  Reasoning: {
    active: "Walking the graph",
    done: "Walked 3 paths",
    rows: [
      { primary: "Maya Chen -[:OWNS]-> Billing after the Q3 reversal." },
      { primary: "The earlier edge Priya -[:OWNED]-> Billing is dated June and superseded." },
    ],
  },
  Search: {
    ...
    rows: [
      { primary: "#billing-owners", secondary: "slack", href: "https://slack.com/" },
      { primary: "RFC: billing ownership", secondary: "github", href: "https://github.com/" },
      { primary: "Q3 reversal note", secondary: "gmail", href: "https://mail.google.com/" },
    ],
  },
  Lookups: {
    active: "Looking up live",
    done: "Looked up just now",
    rows: [
      { primary: "gmail.search", secondary: "from:cfo billing owner", mono: true },
      { primary: "github.issue", secondary: "org/billing#441", mono: true },
      { primary: "slack.thread", secondary: "#billing-owners", mono: true },
    ],
  },
};
