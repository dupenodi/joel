...
export default function ChatComposer() {
  ...
  const [submitted, setSubmitted] = useState("Who owns billing after the Q3 reversal?");
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto px-3 pt-2.5 pb-1">
        ...
        {phase === "reply1" || phase === "reply2" || phase === "done" ? (
          <Section
            ...
            sub="3 paths"
            time="4s"
            body="Maya Chen -[:OWNS]-> Billing. Priya’s edge is dated June and superseded."
          />
        ) : null}
        {phase === "reply2" || phase === "done" ? (
          <Section
            ...
            sub="Cited"
            time="2s"
            body="Maya owns billing. The on-call rotation still lists her as of just now."
