...
**Status 2026-08-20 — stamp + read table + channel membership + personal connectors all done.** Leasing remains not built. `scripts/check_visibility.py` green (`check_channel_membership`), `scripts/check_personal_connectors.py` (new) green.
